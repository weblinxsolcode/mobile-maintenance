...
<div class="form-card">
    <div class="form-card-header">
        <div style="width:38px;height:38px;border-radius:10px;background:#dbeafe;display:flex;align-items:center;justify-content:center;color:#2563eb;font-size:18px;">
    ...
    <div class="form-card-body">
        <form action="{{ route('admin.app_users.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-4 text-center">
                <label for="profile_picture" style="cursor:pointer;">
                    <div class="avatar-preview-wrap mx-auto" id="avatarWrap">
                        <i class="bi bi-camera placeholder-icon" id="avatarIcon"></i>
                        <img id="avatarPreview" src="" style="display:none;">
                    </div>
                    <div style="font-size:12px; color:#64748b; margin-top:8px;">Click to upload photo</div>
                </label>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="email" name="email" class="form-control-custom @error('email') is-invalid @enderror"
                        placeholder="user@email.com" value="{{ old('email') }}">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="phone_number" class="form-control-custom @error('phone_number') is-invalid @enderror"
                        placeholder="+92 300 0000000" value="{{ old('phone_number') }}">
