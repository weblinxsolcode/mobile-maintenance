            ...
            <div class="col-md-12">
                <div class="card">
                    {{-- <div class="card-header pb-0">
                            <ul class="nav nav-tabs nav-tabs-bottom border-0">
                                <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#tab1"
                                        data-discover="true">All ({{ count($appliedJobs) }})</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tab2"
                            data-discover="true">Accepted
                            ({{ $appliedJobs->where('status', 'accepted')->count() }})</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tab3"
                            data-discover="true">Pending
                            ({{ $appliedJobs->where('status', 'pending')->count() }})</a></li>
                    </ul>
                </div> --}}
                <div class="card-body">
                    <div class="table-responsive">
                        <div class="tab-content pt-0" bis_skin_checked="1">
                                ...
                                <table class="datatable table table-hover table-center mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {{ ucfirst(Str::limit($item->service->title ?? 'N/A', 50)) }}
                                            </td>
                                            <td>
                            ...
                            <div class="tab-pane" id="tab2" bis_skin_checked="1">
                                <table class="datatable table table-hover table-center mb-0">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                    ...
                                    <tbody>
                                        @foreach ($appliedJobs->where('status', 'accepted') as $item)
                                        <tr>
                                            <td>{{ $loop->iteration }}</td>
                            ...
                            <div class="tab-pane" id="tab3" bis_skin_checked="1">
                                <table class="datatable table table-hover table-center mb-0">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                    ...
                                    <tbody>
                                        @foreach ($appliedJobs->where('status', 'pending') as $item)
                                        <tr>
                                            <td>{{ $loop->iteration }}</td>
