        ...
        <div class="content container-fluid">
            ...
            <div class="page-header mb-4">
                <div class="row align-items-center">
                    <div class="col-sm-12">
                        <h3 class="page-title">Shop Dashboard</h3>
                        <ul class="breadcrumb">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div>
                                    ...
                                    <h3 class="mb-0 fw-semibold">{{ $totalTechnicians }}</h3>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div>
                                    ...
                                    <h3 class="mb-0 fw-semibold">{{ $totalJobOffersPending }}</h3>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div>
                                    ...
                                    <h3 class="mb-0 fw-semibold">{{ $totalJobOffersAccepted }}</h3>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div>
                                    ...
                                    <h3 class="mb-0 fw-semibold">{{ $totalReviews }}</h3>
                                </div>
